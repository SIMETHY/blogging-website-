export function renderCategories(container) {
    container.innerHTML = `
        <div class="container mx-auto px-4 py-8">
            <header class="mb-8">
                <h1 class="text-4xl font-bold mb-2 text-gray-900 dark:text-white" data-aos="fade-right" data-aos-delay="100">Blog Categories</h1>
                <p class="text-xl text-gray-600 dark:text-gray-400" data-aos="fade-right" data-aos-delay="200">Explore our articles by topic</p>
            </header>
...
function renderCategorySection(category, posts) {
    return `
        <section class="bg-white dark:bg-gray-800 rounded-lg shadow-md p-6" data-aos="fade-up" data-aos-delay="400">
